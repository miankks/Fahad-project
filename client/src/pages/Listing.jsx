    ...
    <main >
        ...
        {listing && !loading && !error && (
            <div>
                ...
                <div className='fixed top-[15%] right-[3%] border rounded-full w-12 h-12
                ...
                <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                    ...
                    <div className="flex gap-4">
                        ...
                        <ul className='flex flex-wrap text-green-900 text-sm font-semibold gap-4 sm:gap-6 items-center'>
                            <li className='flex gap-1 justify-between items-center whitespace-nowrap'>
...
// whitespace-nowrap for smaller screen not to break line