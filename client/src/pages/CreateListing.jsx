...
const CreateListing = () => {
    ...
    const [formData, setFormData] = useState({
        imageUrls: ['https://images.pexels.com/photos/186077/pexels-photo-186077.jpeg',
    ...
    const handleImageSubmit = (e) => {
        if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
            ...
            Promise.all(promises).then((urls) => {
                // to keep the old images, use concat for urls
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    ...
                    <button type='button' className='p-3 text-green-700 border 
            ...
            {
                formData.imageUrls > 0 && formData.imageUrls.map((url, index) => (
