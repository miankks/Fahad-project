...
const About = () => {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className="text-3xl font-bold mb-4 text-slate-800">About Blacksky</h1>
      <p className='mb-4 text-slate-700'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque 
