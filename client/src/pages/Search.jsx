...
const Search = () => {
    ...
    const navigate = useNavigate();
       ...
       useEffect(() => {
        ...
        const sorfFromUrl = urlParams.get('sort')
        ...
        if (
            ...
            // the url is string to need to find as string e-g parking, furnished, offer
            setSidebardata({
    ...
    <div className='flex flex-col md:flex-row'>
        ...
        <div className=''>
            <h1 className='text-3xl font-semibold border-b p-3 text-slate-700 mt-5'>Listing results:</h1>
                {listings && <p className='p-5 font-semibold'>Search result: {listings.length}</p>}
            <div className='p-7 flex flex-row flex-wrap gap-4'>
                {!loading && listings.length === 0 &&(
                    <p className='text-xl text-slate-700'>No listing found!</p>
                )}
                {loading && (
                    <p className='flex text-xl text-slate-700 text-center w-full'>Loading...</p>
                )}
